...
<body style="background-image: url('pic1.jpg'); background-position: center; background-size: cover;">
  ...
  <div class="container">
    <div class="text-center mb-4">
      <h3 style="color: white;">Edit Books Information</h3>
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px; background-color: white; padding: 20px; border-radius: 15px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);">
        <div class="row mb-3">
          <div class="col">
